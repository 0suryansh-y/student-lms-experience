...
export const eligibilities = mysqlTable("eligibilities", {
	...
	tenthPercentage: double("tenth_percentage", { precision: 8, scale: 2 }),
	twelfthPercentage: double("twelfth_percentage", { precision: 8, scale: 2 }),
	graduationPercentage: double("graduation_percentage", { precision: 8, scale: 2 }),
...
export const unitMovementRules = mysqlTable("unit_movement_rules", {
	...
	priority: double({ precision: 8, scale: 2, unsigned: true }).notNull(),
	minWeightedScore: double("min_weighted_score", { precision: 8, scale: 2 }),
	maxWeightedScore: double("max_weighted_score", { precision: 8, scale: 2 }),
	minAttendancePercentage: double("min_attendance_percentage", { precision: 8, scale: 2 }),
	maxAttendancePercentage: double("max_attendance_percentage", { precision: 8, scale: 2 }),
	minAssignmentPercentage: double("min_assignment_percentage", { precision: 8, scale: 2 }),
	maxAssignmentPercentage: double("max_assignment_percentage", { precision: 8, scale: 2 }),
